...
func (s *authService) routes() {
	...
	// s.mux.Delete("/login", s.handleLogout())
}
...
// func (s *Service) newUser(w http.ResponseWriter, r *http.Request, u *user.User) (err error) {
// 	// var dto User
// 	// if err = s.Decode(w, r, &dto); err != nil {
// 	// 	return
// 	// }
...
// func (s *Service) authenticate(w http.ResponseWriter, r *http.Request, public jwk.Key) (*user.User, error) {
...
// func (s *Service) signedTokens(private jwk.Key, u *user.User) (its, ats, rts []byte, err error) {
// 	o := auth.TokenOption{
// 		Issuer:  issuer,
