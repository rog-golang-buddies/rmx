...
import (
	...
	internal "github.com/rog-golang-buddies/rmx/services/auth"
...
func NewService(credRepo repo.CredentialsRepo, opts ...AuthOption) http.Handler {
	...
	s := &authService{mux: service.New(), r: credRepo}
...
func (s *authService) handleCreateCredentials() http.HandlerFunc {
	...
	newCreds := func(w http.ResponseWriter, r *http.Request, creds *internal.Credentials) error {
		var dto payload
...
type AuthOption service.Option[*authService]
